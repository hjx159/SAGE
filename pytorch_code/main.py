...
parser.add_argument('--lr_dc_step', type=int, default=10, help='the number of steps after which the learning rate decay') # 原本是3、10
...
parser.add_argument('--n_layers', type=int, default=2, help='num of layers of lintransformer')
...
log_filename = 'log/' + opt.dataset + '_current_time=' + current_time + '_batchSize=' + str(opt.batchSize) + '_hiddenSize=' + str(opt.hiddenSize) + \
    '_lr_dc_step='+ str(opt.lr_dc_step) +'_seed=' + str(opt.seed) + '_n_layers=' + str(opt.n_layers)  +'.log'
