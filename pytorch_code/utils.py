...
class Data:
    ...
    def generate_batch(self, batch_size):
        if self.shuffle:
            ...
            self.pos = self.pos[shuffled_arg]
            self.targets = self.targets[shuffled_arg]
            self.neg_inputs = self.neg_inputs[shuffled_arg]
